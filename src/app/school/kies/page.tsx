...
export const metadata: Metadata = { title: 'Kies zeilschool · VaarSamen' }

export default async function KiesSchoolPage() {
    ...
    <div className="min-h-dvh bg-surface flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-sm space-y-6">
        <div className="text-center space-y-1">
          ...
          <h1 className="font-headline font-black text-2xl text-on-surface">Kies een school</h1>
          <p className="font-body text-sm text-on-surface-variant">
            Je bent gekoppeld aan meerdere zeilscholen
          </p>
        </div>
